...
const InfraredTriggerIcon: React.FC = () => (
  <svg
    className="size-20"
    viewBox="0 0 24 24"
    fill="none"
  ...
  >
    ...
    <path
      ...
      strokeLinecap="round"
    />
    <circle cx="12" cy="19" r="2" stroke="#6fb43f" strokeWidth="1.5" />
    <path
    ...
    <path
      ...
      strokeLinecap="round"
    />
    <circle opacity="0.5" cx="6" cy="5" r="1" fill="#6fb43f" />
    <circle opacity="0.5" cx="6" cy="11" r="1" fill="#6fb43f" />
  </svg>
);

export default InfraredTriggerIcon;
